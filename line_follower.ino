/* 
    this is the code for a arduino based robot using IR sensors that has implemented using PID control to detect a line 
    which is consist of black and white colour int the either side of it.
    Line eg ;
    =====================================================================
